...
public class PhoneInfoPackage {
    ...
    public PhoneInfoPackage(boolean useBackCamera, boolean phoneIsPortrait, double forwardDisplacement, double upwardDisplacement, double leftwardDisplacement) {
        if (useBackCamera)
